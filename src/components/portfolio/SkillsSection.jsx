...
export default function SkillsSection() {
  return (
    <section className="py-32 px-16 bg-gradient-to-b from-[#001a3d] via-[#0f0a2e] to-[#0a0514]">
          ...
          {skills.map((skill, index) => {
            ...
            return (
              <motion.div
                ...
                className="group p-8 rounded-2xl bg-[#0f0a1f]/80 border border-cyan-900/30 hover:border-cyan-500/50 transition-all duration-500"
              >
