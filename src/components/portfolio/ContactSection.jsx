...
export default function ContactSection() {
  return (
    <section id="contact" className="bg-[#100f0f] px-16 py-32">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <motion.div
            ...
            <h2 className="text-5xl md:text-6xl font-bold text-white mb-12 leading-tight">让我们一起创造更多可能
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }} className="py-40 space-y-12">
