        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          ...
          <motion.div
            ...
            <motion.div
              ...
              { title: 'QQ', image: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/698ddbdd72ba750ccf34f1a0/7c2c43147_image.png' },
              { title: '小红书', image: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/698ddbdd72ba750ccf34f1a0/45cae72b1_image.png' }].
              map((qr, index) =>
              <div
                key={qr.title}
